...
namespace ListViewApp
{
    public partial class FrmMain : Form
    {
        ...
        {
            ListViewItem itemSwtich = new ListViewItem("Nintendo Switch", 0);
            itemSwtich.SubItems.Add("600,000");
            itemSwtich.SubItems.Add("10");
            itemSwtich.SubItems.Add("6,000,000");
            ...
            LsvProducts.Items.AddRange(new ListViewItem[] { itemSwtich, itemDs, itemPs, itemWii, itemXbox });
        }
        ...
        private void LsvProducts_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var selected = LsvProducts.SelectedItems; // 컬랙션, 배열은 항상 foreach
