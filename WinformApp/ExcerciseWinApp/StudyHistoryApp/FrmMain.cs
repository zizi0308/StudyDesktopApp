...
namespace StudyHistoryApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            hanover.Nodes.Add("GRG1", "조지 1세(1714~1727)"); // 각 노드마다 키 값("GRG1")을 줌, 수정을 용이하게 함
        ...
        private void TrvList_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            if (e.Node.Name == "ANN1")
            {
                PcbPhoto.Image = Bitmap.FromFile("./History_Images/Anne.jpg");
                TxtDescription.Text = "앤 여왕은 1702년 3월 8일 " +
                    "Lorem ipsum dolor sit amet consectetur adipisicing elit.Dolorum porro ullam magni amet incidunt eos numquam" +
                    "accusamus consequuntur reiciendis sapiente, corrupti iusto obcaecati unde ipsum, expedita illum dolor, quam velit." +
                    "laborum nemo veniam optio quisquam earum aperiam esse soluta eligendi unde dolore impedit.";
            }
            else if (e.Node.Name == "GRG1")
            {
                PcbPhoto.Image = Bitmap.FromFile("./History_Images/King_George_I.jpg");
